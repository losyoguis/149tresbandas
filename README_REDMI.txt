...
BILLAR TRES BANDAS - VERSIÓN REDMI / PWA

Puedes usar esta versión en Redmi sin instalar APK:
1. Copia la carpeta al celular o súbela a un servidor.
2. Abre index.html en Chrome.
3. Si la abres desde un servidor https, Chrome permite instalarla desde el menú: “Agregar a pantalla de inicio”.
4. Gira el celular en horizontal para jugar mejor.

NOVEDADES:
- Modo Técnica video con 149 carambolas.
- Imágenes de referencia para las jugadas 001 a 149.
- Al tocar Tirar en Técnica video, la bola blanca sigue la ruta guiada para completar la carambola.
- En modo libre se conserva el tiro físico real con taco, efecto y potencia.

Para APK real, usa Capacitor, PWABuilder o un proyecto Android Studio/WebView con esta carpeta como contenido web.
...
Actualización imágenes 061-149: se reforzaron las imágenes generadas con diamantes visibles en las cuatro bandas, manteniendo solo Imagen 1 e Imagen 2 en el visor.
